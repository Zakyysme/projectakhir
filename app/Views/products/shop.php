                    ...
                    <div class="col-xl-12 col-lg-8">
                        ...
                        <div class=" row g-4">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="product__item bor">
                                    ...
                                    <a class="product__cart d-block bor-top"
                                        href="<?= base_url('products/edit/' . $product['id']) ?>"><i
                                            class="fa-regular primary-color me-1"></i>
                                        <span>Edit Product</span></a>
                                    <a class="product__cart d-block bor-top"
                                        href="<?= base_url('products/delete/' . $product['id']) ?>"><i
                                            class="fa-regular primary-color me-1"></i>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="product__item bor">
                                    <div class="product__content">
                                        <a class="primary-hover" href="/products/create">
