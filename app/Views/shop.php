                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="product__item bor">
                                    ...
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="/shop-single">Battery And
                                                Charger Kit</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="product__item bor">
                                    ...
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="/shop-single">Pods Sold
                                                Separately</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="product__item bor">
                                    ...
                                    <div class="product__content">
                                        <h4 class="mb-15"><a class="primary-hover" href="/shop-single">100ml Nic
                                                Salt Juice</a></h4>
                                        <del>$74.50</del><span class="primary-color ml-10">$49.50</span>
                                        <div class="star mt-20">
                                            <i class="fa-solid fa-star"></i>
